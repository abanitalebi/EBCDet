...
USERNAME = os.environ['USER'] = os.environ['USER'] if os.environ.get('USER') is not None else "workspace"
GUILD_HOME = os.environ['GUILD_HOME'] = os.environ['GUILD_HOME'] if os.environ.get('GUILD_HOME') is not None else "."
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/cross_domain/pascal-source.yml', help='data.yaml path')
